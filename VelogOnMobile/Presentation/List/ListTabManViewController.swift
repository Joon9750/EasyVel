...
class ListTabManViewController: TabmanViewController {
    ...
    private var viewControllers: Array<UIViewController> = [SubscriberListViewController(), SubscriberListViewController()]
...
extension ListTabManViewController: PageboyViewControllerDataSource, TMBarDataSource {
  func barItem(for bar: TMBar, at index: Int) -> TMBarItemable {
      switch index {
      case 0:
          return TMBarItem(title: "Keyword list")
      case 1:
          return TMBarItem(title: "Subscriber list")
      default:
